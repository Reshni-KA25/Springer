...
SELECT * FROM (
    ...
    SELECT 'Admin', 'admin@kanini.com', '$2a$10$xN7xL8kC.N6A9G5S8F5EHuQK7x8K6F8W4L9M5N6P7Q8R9S0T1U2V3', 'Data Analytics & AI', 'Coimbatore', (SELECT role_id FROM roles WHERE role_name = 'SYSTEM_ADMIN'), TRUE, NOW() UNION ALL
