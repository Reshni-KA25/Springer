...
} from "../types/TA_Recruiter/Drive/driveAssignment.types";
import type { 
  CandidateRequest, 
  CandidateResponse,
...
} from "../types/TA_Recruiter/Drive/candidateEvaluation.types";
import type { 
  ApplicationRequest, 
  ApplicationResponse,
...
} from "../types/TA_Recruiter/Drive/application.types";
...
export const driveScheduleApi = {
   ...
   * POST /api/drive-schedules
   */
  async createDrive(data: DriveRequest): Promise<ApiResponse<DriveResponse>> {
    try {
      const response = await http.post('/drive-schedules', data);
      return response.data;
    } catch (error) {
      throw handleAxiosError(error);
    }
   ...
   * GET /api/drive-schedules/{driveId}
   */
  async getDriveById(driveId: number): Promise<ApiResponse<DriveResponse>> {
    try {
      const response = await http.get(`/drive-schedules/${driveId}`);
      return response.data;
    } catch (error) {
      throw handleAxiosError(error);
    }
   ...
   * GET /api/drive-schedules
   */
  async getAllDrives(): Promise<ApiResponse<DriveResponse[]>> {
    try {
      const response = await http.get('/drive-schedules');
      return response.data;
    } catch (error) {
      throw handleAxiosError(error);
    }
   ...
   * PATCH /api/drive-schedules/{driveId}
   */
  async updateDrive(driveId: number, data: DriveUpdateRequest): Promise<ApiResponse<DriveResponse>> {
    try {
      const response = await http.patch(`/drive-schedules/${driveId}`, data);
      return response.data;
    } catch (error) {
      throw handleAxiosError(error);
    }
   ...
   * GET /api/drive-schedules/{driveId}/evaluations-summary
   */
  async getEvaluationsSummaryByDriveId(driveId: number): Promise<ApiResponse<CandidateEvaluationSummaryResponse[]>> {
    try {
      const response = await http.get(`/drive-schedules/${driveId}/evaluations-summary`);
      return response.data;
    } catch (error) {
      throw handleAxiosError(error);
    }
...
export const applicationApi = {
   ...
   */
  async createApplications(data: ApplicationRequest): Promise<ApiResponse<BulkApplicationResponse>> {
    try {
   ...
   */
  async getAllApplications(): Promise<ApiResponse<ApplicationResponse[]>> {
    try {
   ...
   */
  async getApplicationsByDriveId(driveId: number): Promise<ApiResponse<ApplicationResponse[]>> {
    try {
      const response = await http.get(`/applications/drive/${driveId}`);
      return response.data;
    } catch (error) {
      throw handleAxiosError(error);
    }
   ...
   */
  async updateApplicationStatus(applicationId: number, data: ApplicationStatusUpdateRequest): Promise<ApiResponse<ApplicationResponse>> {
    try {
      const response = await http.patch(`/applications/${applicationId}/status`, data);
      return response.data;
    } catch (error) {
      throw handleAxiosError(error);
    }
   ...
   */
  async bulkUpdateApplicationStatus(data: BulkApplicationStatusUpdateRequest): Promise<ApiResponse<BulkApplicationStatusUpdateResponse>> {
    try {
      const response = await http.patch('/applications/bulk/status', data);
      return response.data;
    } catch (error) {
      throw handleAxiosError(error);
    }
